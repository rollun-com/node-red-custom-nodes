...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentApi.ContestPaymentDisputeRequest();
  });
  ...
  describe('ContestPaymentDisputeRequest', function() {
    it('should create an instance of ContestPaymentDisputeRequest', function() {
      // uncomment below and update the code to test ContestPaymentDisputeRequest
      //var instane = new FulfillmentApi.ContestPaymentDisputeRequest();
      //expect(instance).to.be.a(FulfillmentApi.ContestPaymentDisputeRequest);
    });
