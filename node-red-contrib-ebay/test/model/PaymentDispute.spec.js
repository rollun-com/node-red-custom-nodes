...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentApi.PaymentDispute();
  });
  ...
  describe('PaymentDispute', function() {
    it('should create an instance of PaymentDispute', function() {
      // uncomment below and update the code to test PaymentDispute
      //var instane = new FulfillmentApi.PaymentDispute();
      //expect(instance).to.be.a(FulfillmentApi.PaymentDispute);
    });
    ...
    it('should have the property availableChoices (base name: "availableChoices")', function() {
      // uncomment below and update the code to test the property availableChoices
      //var instane = new FulfillmentApi.PaymentDispute();
      //expect(instance).to.be();
    });

    it('should have the property buyerProvided (base name: "buyerProvided")', function() {
      // uncomment below and update the code to test the property buyerProvided
      //var instane = new FulfillmentApi.PaymentDispute();
      //expect(instance).to.be();
    });
    ...
    it('should have the property evidenceRequests (base name: "evidenceRequests")', function() {
      // uncomment below and update the code to test the property evidenceRequests
      //var instane = new FulfillmentApi.PaymentDispute();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sellerResponse (base name: "sellerResponse")', function() {
      // uncomment below and update the code to test the property sellerResponse
      //var instane = new FulfillmentApi.PaymentDispute();
      //expect(instance).to.be();
    });
