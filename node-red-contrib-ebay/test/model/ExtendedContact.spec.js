...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentApi.ExtendedContact();
  });
  ...
  describe('ExtendedContact', function() {
    it('should create an instance of ExtendedContact', function() {
      // uncomment below and update the code to test ExtendedContact
      //var instane = new FulfillmentApi.ExtendedContact();
      //expect(instance).to.be.a(FulfillmentApi.ExtendedContact);
    });
