...
<script>
  ...
  const createApi = async () => {
    try {
      ...
      // save old parameter objects (openapi-client version <0.2) - changed from object to array objects
...
<style>
  :global(#openapi-client .required, #openapi-client .required label) {
    font-weight: bold!important;
	}
  :global(#openapi-client .label) {
    width: 104px;
  }
  :global(#openapi-client .parameterInput label) {
    width: 17px !important;
  }
  :global(#openapi-client #node-input-openApiUrl) {
    width: 70%
  }
  :global(#openapi-client .red-ui-editableList-item-content div) {
    margin-top: 0px !important;
    margin-bottom: 0px !important;
  }
  :global(#openapi-client .red-ui-editableList-container) {
    min-height: 300px;
    height: 100% !important;
    overflow-y: hidden !important;
  }
  :global(#openapi-client .red-ui-editableList .red-ui-typedInput-container) {
    width: 90% !important;
  }
  :global(#openapi-client .nodeError) {
    color: red;
  }

</style>

<div id='openapi-client'>
  <Input bind:node prop='name' placeholder='openapi-client' />
